...
const epramaanPath = path.resolve(__dirname, 'contracts', 'epramaan.sol')
const source = fs.readFileSync(epramaanPath, 'utf8'); //to read the contents or file utf8 is the type of encoding sed in
